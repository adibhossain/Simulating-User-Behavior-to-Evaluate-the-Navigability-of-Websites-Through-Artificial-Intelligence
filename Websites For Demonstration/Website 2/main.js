...
var get_web_properties = function () {
  ...
  buttons.forEach(function (button) {
    ...
    var text_size_loop = parseInt(
      computedStyles_loop.getPropertyValue("font-size")
    );
    largest_text_size = Math.max(largest_text_size, text_size_loop);
    smallest_text_size = Math.min(smallest_text_size, text_size_loop);

    var button_width_loop = parseInt(
      computedStyles_loop.getPropertyValue("width")
    );
    ...
    var button_height_loop = parseInt(
      computedStyles_loop.getPropertyValue("height")
    );
    largest_button_height = Math.max(largest_button_height, button_height_loop);
    smallest_button_height = Math.min(
      smallest_button_height,
      button_height_loop
    );
...
var get_features = function (clicked_this) {
  ...
  var button_width_ratio_with_largest_button_width =
    button_width / largest_button_width;
  var button_width_ratio_with_smallest_button_width =
    button_width / smallest_button_width;

  var button_height = parseInt(computedStyles.getPropertyValue("height"));
  var button_height_ratio_with_largest_button_height =
    button_height / largest_button_height;
  var button_height_ratio_with_smallest_button_height =
    button_height / smallest_button_height;

  var button_colors = extractRGB(
  ...
  var parent_colors = extractRGB(
    computedStyles_parent.getPropertyValue("background-color")
  );
  var button_contrast_with_background = calculateContrast(
    button_colors,
    parent_colors
  );
  ...
  var button_is_on_left_half_of_screen =
    button_center_x_coordinate < screen_width / 2;
  var button_is_on_right_half_of_screen =
    button_center_x_coordinate > screen_width / 2;
  var button_is_on_upper_half_of_screen =
    button_center_y_coordinate < screen_height / 2;
  var button_is_on_lower_half_of_screen =
    button_center_y_coordinate > screen_height / 2;
  var button_is_on_horizontal_center_of_screen =
    button_center_x_coordinate == screen_width / 2;
  var button_is_on_vertical_center_of_screen =
    button_center_y_coordinate == screen_height / 2;
  ...
  var button_text_size_ratio_with_largest_button_text =
    button_text_size / largest_text_size;
  var button_text_size_ratio_with_smallest_button_text =
    button_text_size / smallest_text_size;
  ...
  var button_text_contrast_with_button = calculateContrast(
    text_colors,
    button_colors
  );

  var button_text_is_bold =
    computedStyles.getPropertyValue("font-weight") >= "600";
  var button_text_is_italic =
    computedStyles.getPropertyValue("font-style") === "italic";
  ...
  return {
    ...
    // button_appearance
    button_width: button_width / screen_width,
    button_width_ratio_with_largest_button_width:
      button_width_ratio_with_largest_button_width,
    button_width_ratio_with_smallest_button_width:
      button_width_ratio_with_smallest_button_width,
    button_height: button_height / screen_height,
    button_height_ratio_with_largest_button_height:
      button_height_ratio_with_largest_button_height,
    button_height_ratio_with_smallest_button_height:
      button_height_ratio_with_smallest_button_height,
    button_color_R: button_color_R / 255,
    button_color_G: button_color_G / 255,
    button_color_B: button_color_B / 255,
    button_color_A: button_color_A,
    button_contrast_with_background: button_contrast_with_background / 21,

    // button_placement
    button_center_x_coordinate: button_center_x_coordinate / screen_width,
    button_center_y_coordinate: button_center_y_coordinate / screen_height,
    button_is_on_navbar: button_is_on_navbar ? 1 : 0,
    button_is_on_footer: button_is_on_footer ? 1 : 0,
    button_is_on_left_half_of_screen: button_is_on_left_half_of_screen ? 1 : 0,
    ...
    button_is_on_horizontal_center_of_screen:
      button_is_on_horizontal_center_of_screen ? 1 : 0,
    button_is_on_vertical_center_of_screen:
      button_is_on_vertical_center_of_screen ? 1 : 0,
    ...
    button_text_size_ratio_with_smallest_button_text:
      button_text_size_ratio_with_smallest_button_text,
    button_text_color_R: button_text_color_R / 255,
    button_text_color_G: button_text_color_G / 255,
    button_text_color_B: button_text_color_B / 255,
    button_text_color_A: button_text_color_A,
    button_text_contrast_with_button: button_text_contrast_with_button / 21,
    button_text_is_bold: button_text_is_bold ? 1 : 0,
    button_text_is_italic: button_text_is_italic ? 1 : 0,
...
function objectsToCSV(objects) {
  ...
  objects.sort(function (a, b) {
    var columnA = a[keys[1]];
    var columnB = b[keys[1]];
...
var test_func = function (button) {
  ...
  if (!vis[features.button_id]) {
    ...
    features.button_rank =
      (total_number_of_buttons_in_the_website - buttons_clicked) /
      total_number_of_buttons_in_the_website;
